...
def split(head, ptrEvenList, ptrOddList):
    ...
    while curr:
        ...
        if curr.num %2 == 0:
            ptrEvenList[0] = insertNode(ptrEvenList[0], 0, curr.num) 
            # print("in if loop: ",curr.num)
            
        else:
            ptrOddList[0] = insertNode(ptrOddList[0], 0, curr.num) 
            #  print("in else loop: ", curr.num)
            
        curr = curr.next
    return ptrEvenList, ptrOddList
